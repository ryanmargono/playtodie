    ...
    if (/Mobi/.test(navigator.userAgent)) return (
        <div id="top" className="mobileContainer">
            <Row style={{ paddingTop: '5%', marginBottom: '0' }}>
                <Col s={4}>
                    <Link style={{fontSize: '18px'}} to='/'> playtodie </Link>
                </Col>
                <Col s={4} style={{width:'100%', paddingTop: '5%', paddingBottom: '5%'}}>
                    <Link to='/'><img className='mobileImg' src='/logo.png'></img></Link>
                </Col>
            </Row>
